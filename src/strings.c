...
const u8 gText_ItemFinderNearby[] = _("Huh?\nThe Item Finder is responding!\pThere's an item buried around here!{PAUSE_UNTIL_PRESS}");
const u8 gText_ItemFinderOnTop[] = _("Oh!\nThe Item Finder is shaking wildly!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ScottMatchCallDesc[] = _("Elusive Wyes");
...
const u8 gText_PkmnScannerOn[] = _("Activating Pokémon Scanner.\n{PAUSE_UNTIL_PRESS}");
const u8 gText_PkmnScannerOff[] = _("Deactivating Pokémon Scanner.\n{PAUSE_UNTIL_PRESS}");
