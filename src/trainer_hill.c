...
static const u16 sPrizeListPokeball[]    = {ITEM_POKE_BALL,        ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_POKE_BALL};
static const u16 sPrizeListGreatball[]   = {ITEM_GREAT_BALL,       ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
static const u16 sPrizeListUltraball[]   = {ITEM_ULTRA_BALL,       ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_ULTRA_BALL};
static const u16 sPrizeListMasterball[]  = {ITEM_MASTER_BALL,      ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_MASTER_BALL};
