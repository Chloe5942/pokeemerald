...
#define B_BIS_BUTTON_PROMPT_BUTTON L_BUTTON
...
#elif B_BIS_BUTTON_PROMPT_BUTTON == L_BUTTON
    static const u8 sBattleInfoSystem_ButtonPromptWindowGfx[] = INCBIN_U8("graphics/battle_interface/bis_l.4bpp");
#else
