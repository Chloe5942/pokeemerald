...
{
    static const u8 sTextNatureDown[] = _("{COLOR}{05}"); // Decreased Stat
    static const u8 sTextNatureUp[] = _("{COLOR}{08}"); // Increased Stat
    static const u8 sTextNatureNeutral[] = _("{COLOR}{01}"); // Unchanged Stat
    u8 *txtPtr;
