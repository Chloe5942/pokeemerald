...
static const u8 sText_ReturnToField[] = _("Return to Field");
...
static const u32 sNewShopMenu_SellerMenuPal_Beauty[] = INCBIN_U32("graphics/new_shop/sellers/beauty/menu.gbapal.lz");
...
static const u32 sNewShopMenu_SellerScrollPal_Beauty[] = INCBIN_U32("graphics/new_shop/sellers/beauty/scroll.gbapal.lz");
...
static const u32 sNewShopMenu_SellerCursorPal_Beauty[] = INCBIN_U32("graphics/new_shop/sellers/beauty/cursor.gbapal.lz");
...
static const u32 sNewShopMenu_SellerMenuPal_Teala[] = INCBIN_U32("graphics/new_shop/sellers/teala/menu.gbapal.lz");
...
static const u32 sNewShopMenu_SellerScrollPal_Teala[] = INCBIN_U32("graphics/new_shop/sellers/teala/scroll.gbapal.lz");
...
static const u32 sNewShopMenu_SellerCursorPal_Teala[] = INCBIN_U32("graphics/new_shop/sellers/teala/cursor.gbapal.lz");
...
static void BuyMenuInitWindows(void)
{
    ...
    BuyMenuPrint(WIN_MULTI, sText_Price, 0, ITEM_PRICE_Y, TEXT_SKIP_DRAW, COLORID_BLACK, FALSE);
    if (IsMartTypeItem(sMartInfo.martType))
    {
        BuyMenuPrint(WIN_MULTI, sText_InBag, 0, ITEM_IN_BAG_Y, TEXT_SKIP_DRAW, COLORID_BLACK, FALSE);
    }
...
static void PrintMoneyLocal(u8 windowId, u32 x, u32 y, u32 amount, u8 colorIdx, u32 align, bool32 copy)
{
    ...
    if (x == RIGHT_ALIGNED_X)
        x = GetStringRightAlignXOffset(FONT_SMALL, gStringVar4, width);
