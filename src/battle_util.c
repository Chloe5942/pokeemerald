...
static void TryToSetUpCombinedMove(void)
{
    ...
    static const struct CombinedMove sCombinedMoves[] = {
        ...
        {MOVE_FLAMETHROWER,  MOVE_GUST,     MOVE_HEAT_WAVE,   STRINGID_WINDBECAMEHEATWAVE},
        {MOVE_FIRE_BLAST,    MOVE_GUST,     MOVE_HEAT_WAVE,   STRINGID_WINDBECAMEHEATWAVE},
        {MOVE_FIRE_SPIN,     MOVE_GUST,     MOVE_HEAT_WAVE,   STRINGID_WINDBECAMEHEATWAVE},
        {MOVE_ERUPTION,      MOVE_GUST,     MOVE_HEAT_WAVE,   STRINGID_WINDBECAMEHEATWAVE},
        {MOVE_OVERHEAT,      MOVE_GUST,     MOVE_HEAT_WAVE,   STRINGID_WINDBECAMEHEATWAVE},
        // Twister
        {MOVE_DRAGON_RAGE,   MOVE_GUST,     MOVE_TWISTER,     STRINGID_WINDBECAMETWISTER},
        {MOVE_DRAGON_BREATH, MOVE_GUST,     MOVE_TWISTER,     STRINGID_WINDBECAMETWISTER},
        // Icy Wind
        {MOVE_POWDER_SNOW,   MOVE_GUST,     MOVE_ICY_WIND,    STRINGID_WINDBECAMEICYWIND},
        {MOVE_ICE_BEAM,      MOVE_GUST,     MOVE_ICY_WIND,    STRINGID_WINDBECAMEICYWIND},
        {MOVE_AURORA_BEAM,   MOVE_GUST,     MOVE_ICY_WIND,    STRINGID_WINDBECAMEICYWIND},
        {MOVE_SHEER_COLD,    MOVE_GUST,     MOVE_ICY_WIND,    STRINGID_WINDBECAMEICYWIND},
        // Muddy Water
        {MOVE_MUD_SHOT,      MOVE_SURF,     MOVE_MUDDY_WATER, STRINGID_WATERTURNEDMUDDY},
        {MOVE_MUD_SLAP,      MOVE_SURF,     MOVE_MUDDY_WATER, STRINGID_WATERTURNEDMUDDY},
        // Hyper Voice
        {MOVE_UPROAR,        MOVE_UPROAR,   MOVE_HYPER_VOICE, STRINGID_VOICESGOTLOUD},
        {MOVE_SNORE,         MOVE_SNORE,    MOVE_HYPER_VOICE, STRINGID_VOICESGOTLOUD},
        {MOVE_SNORE,         MOVE_UPROAR,   MOVE_HYPER_VOICE, STRINGID_VOICESGOTLOUD},
        // Blizzard
        {MOVE_POWDER_SNOW,   MOVE_ICY_WIND, MOVE_BLIZZARD,    STRINGID_ICYWINDBECAMEBLIZZARD},
        {MOVE_ICE_BEAM,      MOVE_ICY_WIND, MOVE_BLIZZARD,    STRINGID_ICYWINDBECAMEBLIZZARD},
        {MOVE_AURORA_BEAM,   MOVE_ICY_WIND, MOVE_BLIZZARD,    STRINGID_ICYWINDBECAMEBLIZZARD},
        {MOVE_SHEER_COLD,    MOVE_ICY_WIND, MOVE_BLIZZARD,    STRINGID_ICYWINDBECAMEBLIZZARD},
        {MOVE_ICY_WIND,      MOVE_ICY_WIND, MOVE_BLIZZARD,    STRINGID_ICYWINDBECAMEBLIZZARD},
    };
