...
static const u32 gItemPearlGfx[] = INCBIN_U32("graphics/excavation/items/pearl.4bpp.lz");
static const u16 gItemPearlPal[] = INCBIN_U16("graphics/excavation/items/pearl.gbapal");
...
static const u32 gItemNuggetGfx[] = INCBIN_U32("graphics/excavation/items/nugget.4bpp.lz");
static const u16 gItemNuggetPal[] = INCBIN_U16("graphics/excavation/items/nugget.gbapal");
...
static const u32 gItemBigPearlGfx[] = INCBIN_U32("graphics/excavation/items/big_pearl.4bpp.lz");
static const u16 gItemBigPearlPal[] = INCBIN_U16("graphics/excavation/items/big_pearl.gbapal");

static const u32 gItemShoalShellGfx[] = INCBIN_U32("graphics/excavation/items/shoal_shell.4bpp.lz");
static const u16 gItemShoalShellPal[] = INCBIN_U16("graphics/excavation/items/shoal_shell.gbapal");

static const u32 gItemShoalSaltGfx[] = INCBIN_U32("graphics/excavation/items/shoal_salt.4bpp.lz");
static const u16 gItemShoalSaltPal[] = INCBIN_U16("graphics/excavation/items/shoal_salt.gbapal");
...
static const struct CompressedSpriteSheet sSpriteSheet_ItemPearl = {
  gItemPearlGfx,
  64*64/2,
  TAG_ITEM_PEARL,
};
...
static const struct CompressedSpriteSheet sSpriteSheet_ItemNugget = {
  gItemNuggetGfx,
  64*64/2,
  TAG_ITEM_NUGGET
};
...
static const struct CompressedSpriteSheet sSpriteSheet_ItemShoalShell = {
  gItemShoalShellGfx,
  64*64/2,
  TAG_ITEM_SHOAL_SHELL
};

static const struct CompressedSpriteSheet sSpriteSheet_ItemShoalSalt = {
  gItemShoalSaltGfx,
  64*64/2,
  TAG_ITEM_SHOAL_SALT,
};
...
static const struct ExcavationItem ExcavationItemList[] = {
  ...
  [ITEMID_NUGGET] = {
    .excItemId = ITEMID_NUGGET,
    .realItemId = ITEM_NUGGET,
    .top = 1,
    .left = 1,
    .totalTiles = 4,
    .tag = TAG_ITEM_NUGGET,
    .sheet = &sSpriteSheet_ItemNugget,
    .paldata = gItemNuggetPal,
  },
  [ITEMID_PEARL] = {
    .excItemId = ITEMID_PEARL,
    .realItemId = ITEM_PEARL,
    .top = 2,
    .left = 2,
    .totalTiles = 9,
    .tag = TAG_ITEM_PEARL,
    .sheet = &sSpriteSheet_ItemPearl,
    .paldata = gItemPearlPal,
  },
  [ITEMID_BIG_PEARL] = {
    .excItemId = ITEMID_BIG_PEARL,
    .realItemId = ITEM_BIG_PEARL,
    .top = 2,
    .left = 2,
    .totalTiles = 9,
    .tag = TAG_ITEM_BIG_PEARL,
    .sheet = &sSpriteSheet_ItemBigPearl,
    .paldata = gItemBigPearlPal,
  },
  [ITEMID_SHOAL_SHELL] = {
    .excItemId = ITEMID_SHOAL_SHELL,
    .realItemId = ITEM_SHOAL_SHELL,
    .top = 2,
    .left = 2,
    .totalTiles = 9,
    .tag = TAG_ITEM_SHOAL_SHELL,
    .sheet = &sSpriteSheet_ItemShoalShell,
    .paldata = gItemShoalShellPal,
  },
  [ITEMID_SHOAL_SALT] = {
    .excItemId = ITEMID_SHOAL_SALT,
    .realItemId = ITEM_SHOAL_SALT,
    .top = 1,
    .left = 2,
    .totalTiles = 6,
    .tag = TAG_ITEM_SHOAL_SALT,
    .sheet = &sSpriteSheet_ItemShoalSalt,
    .paldata = gItemShoalSaltPal,
  },
  // Fossils
  [ITEMID_ROOT_FOSSIL] = {
    .excItemId = ITEMID_ROOT_FOSSIL,
    .realItemId = ITEM_ROOT_FOSSIL,
    .top = 3,
    .left = 3,
    .totalTiles = 16,
    .tag = TAG_ITEM_ROOT_FOSSIL,
    .sheet = &sSpriteSheet_ItemRootFossil,
    .paldata = gItemFossilPal,
  },
  [ITEMID_CLAW_FOSSIL] = {
    .excItemId = ITEMID_CLAW_FOSSIL,
    .realItemId = ITEM_CLAW_FOSSIL,
    .top = 3,
    .left = 3,
    .totalTiles = 16,
    .tag = TAG_ITEM_CLAW_FOSSIL,
