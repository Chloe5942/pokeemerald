...
// Custom
const u32 gItemIcon_PokeScanner[] = INCBIN_U32("graphics/items/icons/poke_scanner.4bpp.lz");
const u32 gItemIconPalette_PokeScanner[] = INCBIN_U32("graphics/items/icon_palettes/poke_scanner.gbapal.lz");
