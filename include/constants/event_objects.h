...
// Custom
#define OBJ_EVENT_GFX_TRUCK_TRAILER              OBJ_EVENT_GFX_UNUSED_NATU_DOLL
#define OBJ_EVENT_GFX_TRUCK_TRAILER_ALT          OBJ_EVENT_GFX_UNUSED_MAGNEMITE_DOLL
#define OBJ_EVENT_GFX_TM_BALL                    OBJ_EVENT_GFX_UNUSED_SQUIRTLE_DOLL
