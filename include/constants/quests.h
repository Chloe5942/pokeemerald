...
#define SUB_QUEST_COUNT (QUEST_RIVAL_NEXT_DOOR_SUB_COUNT + QUEST_SCOUTING_SCOTT_SUB_COUNT + QUEST_PUZZLE_SOLVER_SUB_COUNT + QUEST_CONTEST_STAR_SUB_COUNT + QUEST_FRONTIER_EXPLORER_SUB_COUNT + QUEST_GIGANTIC_FINDINGS_SUB_COUNT + QUEST_SEAFARER_SUB_COUNT) // 41/168 127 Free Spaces Left
