...
#define MAP_POPUP_TIME_MODE         MAP_POPUP_TIME_12_HR     // determines what type of time is shown
#define MAPPOPUP_ALPHA_BLEND        FALSE                    // enables alpha blending/transparency for the pop-ups
